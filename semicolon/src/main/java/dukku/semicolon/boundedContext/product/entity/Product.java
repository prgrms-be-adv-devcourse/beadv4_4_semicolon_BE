...
public class Product extends BaseIdAndUUIDAndTime {
    ...
    public static Product create(
        ...
        if (sellerUuid == null) throw new IllegalArgumentException("sellerUuid는 필수입니다.");
        ...
        if (price == null || price < 0) throw new IllegalArgumentException("price는 0 이상이어야 합니다.");
        if (shippingFee != null && shippingFee < 0) throw new IllegalArgumentException("shippingFee는 0 이상이어야 합니다.");
